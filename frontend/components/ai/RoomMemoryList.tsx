...
export default function RoomMemoryList({ roomId }: { roomId: number }) {
  ...
  return (
    <section className="space-y-3 border-b border-border pb-5">
      <div className="flex items-center justify-between gap-3">
        <div>
          <h3 className="text-sm font-semibold text-foreground">Room memory</h3>
            ...
            <div key={memory.id} className="rounded-lg border border-border bg-muted/40 p-3">
              ...
              <div className="mt-2 flex flex-wrap items-center gap-x-2 gap-y-1 text-[11px] text-muted-foreground">
                ...
                {memory.source_type === "message" && memory.source_id ? (
                  <a href={`/rooms/${roomId}#message-${memory.source_id}`} className="text-primary hover:underline">
