...
import { Message } from "@/lib/store/roomStore";
...
export default function ChatArea({
  ...
  const deskQueue = queue.filter(q => q.room_id === roomId && q.desk_id === activeDeskId);
